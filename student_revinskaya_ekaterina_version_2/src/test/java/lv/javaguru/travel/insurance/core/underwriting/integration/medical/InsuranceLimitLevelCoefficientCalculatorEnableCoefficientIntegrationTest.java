...
public class InsuranceLimitLevelCoefficientCalculatorEnableCoefficientIntegrationTest {
    @Autowired
    private TravelPremiumUnderwriting premiumUnderwriting;

    @Test
    public void InsuranceLimitLevelCoefficientEnableTest() {
        PersonDTO person = PersonDTO.builder()
                .personFirstName("Vasja")
                .personLastName("Pupkin")
                .personBirthDate(createDate("01.01.2012"))
                .medicalRiskLimitLevel("LEVEL_50000").build();
