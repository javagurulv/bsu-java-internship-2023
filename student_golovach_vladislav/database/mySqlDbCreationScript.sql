...
values (1, 'RISK_TYPE', 'travel policy risk type classifier'), (2, 'COUNTRY', 'country classifier');
insert ignore into classifier_values
values (1, 1, 'TRAVEL_MEDICAL', 'travel policy medical risk'),
       (2, 1, 'TRAVEL_CANCELLATION','travel policy trip cancellation risk'),
       (3, 1, 'TRAVEL_LOSS_BAGGAGE','travel policy baggage lose risk'),
        (4, 2, 'LATVIA', 'country Latvia'),
       (5, 2, 'SPAIN', 'country Spain');
