...
public class TravelCalculatePremiumRequestValidatorTest {
    ...
    void ShouldReturnErrorWhenFirstNameIsNull(){
        ...
        when(request.getAgreementDateTo()).thenReturn(CreateDate("21.06.2006"));
        when(request.getAgreementDateFrom()).thenReturn(CreateDate("21.02.2006"));
    ...
    void ShouldReturnErrorWhenAgreementDateFromIsNull(){
        TravelCalculatePremiumRequest request = mock(TravelCalculatePremiumRequest.class);
        when(request.getPersonFirstName()).thenReturn("Alex");
        when(request.getAgreementDateTo()).thenReturn(CreateDate("21.06.2004"));
    ...
    void ShouldReturnErrorWhenDateToNotAfterDateFrom() throws ParseException {
        ...
        when(request.getPersonLastName()).thenReturn("Pard");
        DateFormat a = new SimpleDateFormat("dd.MM.yyyy");
        when(request.getAgreementDateFrom()).thenReturn(a.parse("21.02.2006"));
        when(request.getAgreementDateTo()).thenReturn(a.parse("21.01.2006"));
