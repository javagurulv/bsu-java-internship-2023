...
public class TravelCalculatePremiumRequestValidatorTest {
    ...
    void shouldReturnAllRight() {
        ...
        when(request.getAgreementDateFrom()).thenReturn(createDate("01-01-2029"));
        when(request.getAgreementDateTo()).thenReturn(createDate("10-01-2029"));
        List<ValidationError> errors = requestValidator.validate(request);
        assertTrue(errors.isEmpty());
        assertEquals(errors.size(), 0);
        assertEquals(request.getPersonFirstName(), "Mixail");
        assertEquals(request.getPersonLastName(), "LastName");
        assertEquals(request.getAgreementDateFrom(), createDate("01-01-2029"));
        assertEquals(request.getAgreementDateTo(), createDate("10-01-2029"));
    }
    ...
    void shouldReturnErrorWhenAgreementDateToIsNull() {
        ...
        when(request.getPersonFirstName()).thenReturn("Mixail");
        when(request.getPersonLastName()).thenReturn("LastName");
        when(request.getAgreementDateFrom()).thenReturn(createDate("10-01-2029"));
