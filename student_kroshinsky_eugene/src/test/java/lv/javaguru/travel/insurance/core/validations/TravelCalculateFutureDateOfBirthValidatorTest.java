...
class TravelCalculateFutureDateOfBirthValidatorTest {
    @Mock
    ...
    @InjectMocks
    private TravelCalculateFutureDateOfBirthValidator validator;
    @Test
    ...
    void validateDateFromPast() {
        when(request.getDateOfBirth()).thenReturn(createDate("15.11.2025"));
