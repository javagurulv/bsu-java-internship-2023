...
class ClassifierValueRepositoryTest {
    ...
    public void shouldFind_RiskType_TRAVEL_MEDICAL() {
        shouldFindRiskTypeAndIc("RISK_TYPE", "TRAVEL_MEDICAL");
    }

    @Test
    public void shouldFind_RiskType_TRAVEL_CANCELLATION() {
        shouldFindRiskTypeAndIc("RISK_TYPE", "TRAVEL_CANCELLATION");
    }

    @Test
    public void shouldFind_RiskType_TRAVEL_LOSS_BAGGAGE() {
        shouldFindRiskTypeAndIc("RISK_TYPE", "TRAVEL_LOSS_BAGGAGE");
    }

    @Test
    public void shouldFind_RiskType_TRAVEL_THIRD_PARTY_LIABILITY() {
        shouldFindRiskTypeAndIc("RISK_TYPE", "TRAVEL_THIRD_PARTY_LIABILITY");
    }

    @Test
    public void shouldFind_RiskType_TRAVEL_EVACUATION() {
        shouldFindRiskTypeAndIc("RISK_TYPE", "TRAVEL_EVACUATION");
    }

    @Test
    public void shouldFind_RiskType_TRAVEL_SPORT_ACTIVITIES() {
        shouldFindRiskTypeAndIc("RISK_TYPE", "TRAVEL_SPORT_ACTIVITIES");
    }
    ...
    private void shouldFindRiskTypeAndIc(String riskType, String ic) {
        Optional<ClassifierValue> valueOpt = classifierValueRepository.findByClassifierTitleAndIc(
                riskType, ic);
        assertTrue(valueOpt.isPresent());
        assertEquals(ic, valueOpt.get().getIc());
        assertEquals(riskType, valueOpt.get().getClassifier().getTitle());
    }
