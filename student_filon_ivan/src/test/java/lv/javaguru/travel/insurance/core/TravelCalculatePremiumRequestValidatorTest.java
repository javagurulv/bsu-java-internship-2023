...
public class TravelCalculatePremiumRequestValidatorTest {
    ...
    public void shouldBeEmptyLastName() throws ParseException {
        TravelCalculatePremiumRequest request = new TravelCalculatePremiumRequest("Ivan", "", new SimpleDateFormat("dd.MM.yyyy").parse("01.06.2005"), new SimpleDateFormat("dd.MM.yyyy").parse("31.05.2005"));
        TravelCalculatePremiumRequestValidator validator = new TravelCalculatePremiumRequestValidator();
    ...
    public void shouldBeEmptyFirstName() throws ParseException {
        TravelCalculatePremiumRequest request = new TravelCalculatePremiumRequest("", "Filon", new SimpleDateFormat("dd.MM.yyyy").parse("01.06.2005"), new SimpleDateFormat("dd.MM.yyyy").parse("31.05.2005"));
        TravelCalculatePremiumRequestValidator validator = new TravelCalculatePremiumRequestValidator();
    ...
    public void shouldBeDateFromGreaterThanDateTo() throws ParseException{
        ...
        TravelCalculatePremiumRequestValidator validator = new TravelCalculatePremiumRequestValidator();
        assertEquals(validator.validate(request).get(0), new ValidationError("agreementDateFrom", "Must not be less than agreementDateTo!"));
        assertEquals(validator.validate(request).size(), 1);
    }
